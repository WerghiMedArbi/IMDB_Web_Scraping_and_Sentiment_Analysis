...
try:
    ...
    while page != 1001:
        ...
        for movie in movies:
            ...
            # review_link= "https://www.imdb.com{}".format(movie.find('h3', class_="lister-item-header").a.get('href'))
            urlreview = review_link + "reviews?sort=totalVotes&dir=desc&ratingFilter=0"
            # urlreview = "{}reviews?sort=totalVotes&dir=desc&ratingFilter=0".format(review_link)
            ...
            for review in reviews:
                ...
                try:
                    ...
                    review_title = None
                film_title = soup.find('h3', itemprop="name").a.get_text(strip=True)  # can be executed outside the for loop for less operations ?
                print(film_title)
            ...
            year = movie.find('span', class_="lister-item-year text-muted unbold").text.strip('()') # famma mass houni idk why
